...
def process_landmarks(image):
    ...
    npy = glob.glob("0_0.npy")
    landmarks = np.load(npy[0], allow_pickle=True)[1]
    # call function for getting the yaw angle value
    yaw_angle = np.load(npy[0], allow_pickle=True)[2][2]
